...
def process_args():
    ...
    parser.add_argument('--wandb_dir', type=str, default='/disk2/wqzhao/TCGA/Part3_Survival/wandb', help='Wandb directory')
    parser.add_argument('--model_weight_dir', type=str, default='/disk2/wqzhao/TCGA/Part3_Survival/model_weights', help='Model weight directory')
    ...
    #----> dataset args
    parser.add_argument('--dataset_csv', type=str, default='/disk2/wqzhao/TCGA/Part3_Survival/dataset_csv/Survival/BRCA_HER2Plus_Survival.csv', help='Dataset csv file path')
    ...
    parser.add_argument('--RNA_csv', type=str, default='/disk2/wqzhao/TCGA/Part3_Survival/TCGA_processed_clinical_and_rna/BRCA/data_mrna_seq_v2_rsem_log2p_hvg1000.csv', help='Extracted RNA feature path')
