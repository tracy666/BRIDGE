...
def main():
    ...
    if args.feature_extractor == 'dinov2_vits14':
        ...
        feature_extractor = FeatureExtractor(model)
    elif args.feature_extractor == "BRIDGE":
        ############ Modify this part according to the path on your own machine ############
        from BRIDGE_code.models.BRIDGE_model import BRIDGEModel
        sample_pretrained_weights_path = ".../weight.ckpt"
        ...
        selected_indices = pd.read_csv("./dataset_csv/BRIDGE_metadata/top_HVG_genes_indices_number_1000.csv", index_col=0).index.tolist()
