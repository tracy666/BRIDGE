...
def get_ground_truth_and_prediction_gene_expressions_for_DenseNet121(
        model,
        dataloader,
        device: torch.device,
...
def get_ground_truth_and_prediction_gene_expressions_for_CTransPath_or_DINO(
        image_encoder,
...
def main():
    ...
    for row in tqdm(valid_df.itertuples(), total=len(valid_df)):
        ...
        if row.organ_type == "nose":
            single_organ_checkpoint = "/disk1/zliang/0000_0901_finalized_checkpoints/STNet/single_organ/STNet_2024_08_07_07_37_14_nose/19.ckpt"
        elif row.organ_type == "ovary":
            single_organ_checkpoint = "/disk1/zliang/0000_0901_finalized_checkpoints/STNet/single_organ/STNet_2024_08_07_07_44_30_ovary/19.ckpt"
        elif row.organ_type == "skin":
            single_organ_checkpoint = "/disk1/zliang/0000_0901_finalized_checkpoints/STNet/single_organ/STNet_2024_08_07_07_56_42_skin/19.ckpt"
        elif row.organ_type == "liver":
            single_organ_checkpoint = "/disk1/zliang/0000_0901_finalized_checkpoints/STNet/single_organ/STNet_2024_08_07_08_34_51_liver/19.ckpt"
        elif row.organ_type == "small_and_large_intestine":
            single_organ_checkpoint = "/disk1/zliang/0000_0901_finalized_checkpoints/STNet/single_organ/STNet_2024_08_07_09_19_53_small_and_large_intestine/19.ckpt"
        elif row.organ_type == "lung":
            single_organ_checkpoint = "/disk1/zliang/0000_0901_finalized_checkpoints/STNet/single_organ/STNet_2024_08_07_11_12_37_lung/19.ckpt"
        elif row.organ_type == "breast":
            single_organ_checkpoint = "/disk1/zliang/0000_0901_finalized_checkpoints/STNet/single_organ/STNet_2024_08_07_13_21_16_breast/19.ckpt"
        elif row.organ_type == "prostate":
            single_organ_checkpoint = "/disk1/zliang/0000_0901_finalized_checkpoints/STNet/single_organ/STNet_2024_08_07_15_29_08_prostate/19.ckpt"
        elif row.organ_type == "heart":
            single_organ_checkpoint = "/disk1/zliang/0000_0901_finalized_checkpoints/STNet/single_organ/STNet_2024_08_07_17_59_50_heart/19.ckpt"
        elif row.organ_type == "brain":
            single_organ_checkpoint = "/disk1/zliang/0000_0901_finalized_checkpoints/STNet/single_organ/STNet_2024_08_07_20_57_17_brain/19.ckpt"
        else:
            raise ValueError
        ...
        single_organ_pretrained_STNet_model = STNetModel.load_from_checkpoint(
        ...
        single_organ_pretrained_STNet_model.eval()
        ...
        if single_organ_pretrained_STNet_model.image_encoder_name == "DenseNet121":
            single_organ_single_slide_gene_ground_truth, single_organ_single_slide_gene_prediction = get_ground_truth_and_prediction_gene_expressions_for_DenseNet121(
                model=single_organ_pretrained_STNet_model.model,
                dataloader=single_organ_single_slide_eval_dataloader,
                device=device,
            )
        elif (single_organ_pretrained_STNet_model.image_encoder_name == "CTransPath") or (single_organ_pretrained_STNet_model.image_encoder_name == "DINOv1") or (single_organ_pretrained_STNet_model.image_encoder_name == "DINOv2"):
            single_organ_single_slide_gene_ground_truth, single_organ_single_slide_gene_prediction = get_ground_truth_and_prediction_gene_expressions_for_CTransPath_or_DINO(
                image_encoder=single_organ_pretrained_STNet_model.image_encoder,
                image_to_gene_decoder=single_organ_pretrained_STNet_model.image_to_gene_decoder,
                dataloader=single_organ_single_slide_eval_dataloader,
                device=device,
            )
        else:
            raise ValueError("Please select the correct image encoder name.")
