...
def main():
    ...
    for organ_type in [
        ...
        print(f"single-organ BLEEP ST reference dataset extraction time: {running_time_display(ST_extraction_end_time - ST_extraction_start_time)}")
        print("---------------------------------------------------------------------------------------------------------------")
        ...
        print(f"single-organ BLEEP ST reference dataset saving time: {running_time_display(starting_end_time - saving_start_time)}")
        print("---------------------------------------------------------------------------------------------------------------")
