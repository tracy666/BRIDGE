...
def get_single_cell_gene_embedding_for_retrieval(
    ...
    for _, batch in tqdm(enumerate(dataloader), total=len(dataloader), desc='Extract gene sampling pool embeddings for retrieval'):
        ...
        if gene_encoder.model_name == "TabNet":
...
def main():
    ...
    for organ_type in [
        ...
        for checkpoint in args.checkpoint_list:
            ...
            print(f"SC Extraction time: {running_time_display(SC_extraction_end_time - SC_extraction_start_time)}")
