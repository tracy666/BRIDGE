...
def main():
    ...
    for organ_type in [
        ...
        print(f"Evaluating multi-organ BRIDGE model checkpoint: {checkpoint} for organ {organ_type}")
        print("---------------------------------------------------------------------------------------------------------------")
        ...
        print(f"multi-organ BRIDGE single-cell reference dataset extraction time: {running_time_display(SC_extraction_end_time - SC_extraction_start_time)}")
        print("---------------------------------------------------------------------------------------------------------------")
        ...
        print(f"multi-organ BRIDGEs single-cell reference dataset saving time: {running_time_display(starting_end_time - saving_start_time)}")
        print("---------------------------------------------------------------------------------------------------------------")
