...
def main():
    ...
    for organ_type in [
        ...
        print(f"single_organ BRIDGE single-cell reference dataset extraction time: {running_time_display(SC_extraction_end_time - SC_extraction_start_time)}")
        print("---------------------------------------------------------------------------------------------------------------")
        ...
        print(f"single_organ BRIDGE single-cell reference dataset saving time: {running_time_display(starting_end_time - saving_start_time)}")
        print("---------------------------------------------------------------------------------------------------------------")
