...
def main():
    ...
    for row in tqdm(few_shot_df.itertuples(), total=len(few_shot_df)):
        ...
        single_organ_BRIDGE_training_image_embedding, single_organ_BRIDGE_training_gene_embedding = get_direct_partial_image_gene_embedding_for_retrieval(
        ...
        single_organ_BRIDGE_whole_distance, single_organ_BRIDGE_whole_indices = get_retrieval_indexes(
            all_train_gene_embedding=single_organ_BRIDGE_training_gene_embedding,
