...
def main():
    ...
    for row in tqdm(valid_df.itertuples(), total=len(valid_df)):
        ...
        multi_organ_training_image_embedding, multi_organ_training_gene_embedding = get_direct_partial_image_gene_embedding_for_retrieval(
            whole_dataset_embedding_folder_path=multi_organ_whole_dataset_embedding_folder_path,
            selected_index_list=single_organ_training_index_list,
        )
        ...
        multi_organ_whole_distance, multi_organ_whole_indices = get_retrieval_indexes(
            all_train_gene_embedding=multi_organ_training_gene_embedding,
