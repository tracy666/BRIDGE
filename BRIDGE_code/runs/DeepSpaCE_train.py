...
def main():
    ...
    parser.add_argument('--config_file_name', type=str, default='DeepSpaCE.yaml', help='Path to the config file')
    ...
    checkpoint_folder_path = os.path.join(hyperparameters.main_data_storage, "checkpoints",
                                          "DeepSpaCE_training_results",
                                          f"DeepSpaCE_{hyperparameters.organ_selected}",
                                          "checkpoints")
    ...
    wandb_logger = WandbLogger(
        name=f"DeepSpaCE_{hyperparameters.organ_selected}",
    ...
    model = DeepSpaCEModel(**vars(hyperparameters))
