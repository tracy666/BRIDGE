...
def main():
    ...
    parser.add_argument('--config_file_name', type=str, default='BLEEP.yaml', help='Path to the config file')
    ...
    parser.add_argument('--latent_embedding_dimension', type=int, default=256)
    ...
    checkpoint_folder_path = os.path.join(hyperparameters.main_data_storage, "checkpoints",
                                          "BLEEP_training_results",
                                          f"BLEEP_{hyperparameters.organ_selected}",
                                          "checkpoints")
    ...
    wandb_logger = WandbLogger(
        name=f"BLEEP_{hyperparameters.organ_selected}",
    ...
    model = BLEEPModel(**vars(hyperparameters))
