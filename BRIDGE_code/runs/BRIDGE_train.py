...
def main():
    ...
    parser.add_argument('--config_file_name', type=str, default='BRIDGE.yaml', help='Path to the config file')
    ...
    parser.add_argument('--gene_encoder_model_name', type=str, default="MLP") # TabNet
    ...
    checkpoint_folder_path = os.path.join(hyperparameters.main_data_storage, "checkpoints",
                                          "BRIDGE_training_results",
                                          f"BRIDGE_{hyperparameters.organ_selected}",
                                          "checkpoints")
    ...
    callbacks = [
        ...
        ModelCheckpoint(
            ...
            verbose=False,
            save_last=True,
            every_n_epochs=5, # used to commented
    ...
    wandb_logger = WandbLogger(
        name=f"BRIDGE_{hyperparameters.organ_selected}",
    ...
    model = BRIDGEModel(**vars(hyperparameters))
